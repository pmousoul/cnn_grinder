...
#ifndef HW_FUNC_FIP_HPP
#define HW_FUNC_FIP_HPP
...
typedef struct p_param_t_struct{
	...
	void hw_conv_mpool_fip( p_fmap_t *fmap_in, p_param_t *param,
...
//void hw_zqn_fip(
//	p_fmap_t* hw_fmap_fip[4], p_param_t* hw_params_fip[ZQN_LN], float* hw_fmap_flp_o, Largs_zqn& larg, float error_sz, bool* error_flag );
