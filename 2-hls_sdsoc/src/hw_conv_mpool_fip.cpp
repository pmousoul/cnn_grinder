// Fixed-point HW CNN Convolution-Max-pooling implementation
		...
		uint8_t ppad, uint8_t pkernel, uint8_t pstride )
{
	...
	hw_conv_fip( fmap_in, param, fmap_out,
		h_in, w_in, ch_in,
		h_out, w_out, ch_out,
		pad, kernel, stride,
		ei, eo, ep, use_relu );

	hw_maxpool_fip( fmap_out, pfmap_out,
